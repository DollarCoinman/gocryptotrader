...
[![GoDoc](https://godoc.org/github.com/DollarCoinman/gocryptotrader?status.svg)](https://godoc.org/github.com/DollarCoinman/gocryptotrader)
...
+ Code must adhere to our [coding style](https://github.com/DollarCoinman/gocryptotrader/blob/master/.github/CONTRIBUTING.md).
...
```bash
git clone https://github.com/DollarCoinman/gocryptotrader.git
cd gocryptotrader
go build
