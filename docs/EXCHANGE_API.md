...
A full breakdown of all the supported wrapper funcs can be found [here.](https://github.com/DollarCoinman/gocryptotrader/blob/master/exchanges/interfaces.go#L21)
