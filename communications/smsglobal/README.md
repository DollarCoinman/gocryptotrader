...
[![GoDoc](https://godoc.org/github.com/DollarCoinman/gocryptotrader?status.svg)](https://godoc.org/github.com/DollarCoinman/gocryptotrader/communications/smsglobal)
...
+ [Enable via configuration](https://github.com/DollarCoinman/gocryptotrader/tree/master/config#enable-communications-via-config-example)

+ Individual package example below:
```go
import (
"github.com/DollarCoinman/gocryptotrader/communications/smsglobal"
