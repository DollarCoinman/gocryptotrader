...
[![GoDoc](https://godoc.org/github.com/DollarCoinman/gocryptotrader?status.svg)](https://godoc.org/github.com/DollarCoinman/gocryptotrader/config)
...
```sh
cd ~/go/src/github.com/DollarCoinman/gocryptotrader
